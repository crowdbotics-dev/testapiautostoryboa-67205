...
## Project Structure
    ...
    ├── testapiautostoryboa_67205  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_67205`
...
2. Clone this repo and `cd testapiautostoryboa_67205`
